...
env_scene = '17DRP5sb8fy' #'17DRP5sb8fy' #'yqstnuAEVhm'
floor_id = 0
scene_name = '17DRP5sb8fy_0' #'17DRP5sb8fy_0' #'yqstnuAEVhm_0'
...
start_pose = (-0.35, -0.85, 0.2964) #(-0.35, -0.85, 0.2964) #(0.03828, -8.55946, 0.2964)
